...
export default class NormalListDataMockUpLoading extends Component {
    ...
    render() {
        ...
        return (
            ...
            <ScrollView style={[ styles.justFlexContainer, styles.paddingTopNavSM, {backgroundColor: 'white'}]}>

                { this._getDataStaticCount().map((mainItem, mainIndex) => {
                    return (

                        <View key={mainIndex} style={[styles.itemContainer, styles.mainHorizontalPadding]}>

                            <View style={[styles.itemSubContainerSM, styles.rowBorderBot, {backgroundColor: 'white', marginBottom: 0,paddingHorizontal: 0,}]}>   
